...
bgPlaceholder:'输入图片URL (留空使用默认)',bgUpload:'上传图片',themeHorizon:'地平线',themeLandscape:'山水',themeEarth:'粒子地球',
...
bgPlaceholder:'Enter image URL (leave empty for default)',bgUpload:'Upload Image',themeHorizon:'Horizon',themeLandscape:'Landscape',themeEarth:'Particle Earth',
...
bgPlaceholder:'画像URLを入力 (空欄でデフォルト)',bgUpload:'画像をアップロード',themeHorizon:'ホライゾン',themeLandscape:'山水',themeEarth:'パーティクル地球',
