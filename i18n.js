...
bgPlaceholder:'输入图片URL (留空使用默认)',bgUpload:'上传图片',
...
bgPlaceholder:'Enter image URL (leave empty for default)',bgUpload:'Upload Image',
...
bgPlaceholder:'画像URLを入力 (空欄でデフォルト)',bgUpload:'画像をアップロード',
