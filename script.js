...
var gm=document.getElementById('gameWidget');if(gm){var wasHidden=gm.style.display==='none';gm.style.display=settings.showGame?'':'none';if(settings.showGame&&wasHidden&&typeof drawStartScreen==='function')drawStartScreen();}
